...
model = DistilBertForSequenceClassification.from_pretrained('bert-base-uncased', num_labels=len(label_to_index))
model.to(device)
...
tokenizer.save_pretrained('./distilbert_intent_model')
